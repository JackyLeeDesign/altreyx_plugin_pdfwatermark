...
# import os
# content_pdf= r"C:/Users/JYKL/Desktop/我是測試.pdf"
# stamp_pdf= r"C:/Users/JYKL/Desktop/Alteryx/Altreyx_AIT_Components/altreyx_plugin_pdfwatermark/alteryx_src/watermark.pdf"
# pdf_temp= r"C:/Users/JYKL/Desktop/我是測試_temp.pdf"
# pdf_result= r"C:/Users/JYKL/Desktop/我是測試_result.pdf"
# page_indices= "ALL"
            ...
            if(isExist == True):
                ...
                if page_indices == "ALL":
                    ...
                    for page in pdfDoc:
                        ...
                        watermark_pic_path = r"C:/Users/JYKL/Desktop/Alteryx/Altreyx_AIT_Components/altreyx_plugin_pdfwatermark/src/watermark.png"
                    ...
                    # 顯示成功與否
                    resultData.at[index_file, "Source File"] = content_pdf
